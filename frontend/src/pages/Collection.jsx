...
import Title from "../components/Title"; // Đảm bảo đường dẫn chính xác
...
const Collection = () => {
  ...
  const applyFilter = () => {
    ...
    if (subCategory.length > 0) {
      productsCopy = productsCopy.filter(item => subCategory.includes(item.subCategory)); // Giả sử sản phẩm có thuộc tính subCategory
    }
